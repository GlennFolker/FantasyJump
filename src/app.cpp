...
namespace Fantasy {
    ...
    App::App(int *argc, char **argv[]) {
        ...
        SDL_Log("Initialized SDL %d.%d.%d", SDL_MAJOR_VERSION, SDL_MINOR_VERSION, SDL_PATCHLEVEL);
        ...
        if((error = glGetError()) != GL_NO_ERROR) {
            SDL_LogError(SDL_LOG_CATEGORY_APPLICATION, "Couldn't initialize GL: %s", gluErrorString(error));
            this->~App();
            return;
        }
